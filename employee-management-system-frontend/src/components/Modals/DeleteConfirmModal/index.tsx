...
export const DeleteConfirmModal = ({ id, show, handleClose }: { id: string, show: boolean, handleClose: () => void }) => {
                    ...
                    <div className="relative w-auto my-6 mx-auto max-w-3xl">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-6 text-center">
                                ...
                                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete product with id {id}?</h3>
                                <button
