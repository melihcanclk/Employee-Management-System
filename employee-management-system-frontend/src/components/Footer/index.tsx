...
const Footer = () => {
    return (
        <>
            <footer
                className="wow fadeInUp dark:bg-gray-dark relative z-10 bg-white pt-12 md:pt-16 lg:pt-20"
                data-wow-delay=".1s"
            >
                <div className="container">
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div className="w-full flex justify-center px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                            <div className="mb-12 max-w-[360px] place-self-center lg:mb-16">
                                <Link href="/" className="mb-8 w inline-block">
                                    <Image
                                ...
                                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                                    Employee management system for small and medium-sized businesses. You can contact 
                                    with us for more information using social media links below.
                                </p>
